...
function authService($http, $q, identity, authorization, errorHandler, baseServiceUrl) {
...
angular.module('myApp.services')
    .factory('auth', ['$http', '$q', 'identity', 'authorization', 'errorHandler', 'baseServiceUrl', authService ]);
